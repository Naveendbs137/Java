 ...
 * 
 * @Bean public OpenAPI deliveryPartnerOpenAPI() { return new OpenAPI()
 * .info(new Info() .title("Delivery Partner API")
 * .description("APIs for Delivery Partner Application") .version("1.0.0")
