...
public class OnboardingController {
    ...
    public ResponseEntity<Map<String, String>> sendOtp(@RequestBody SendOtpDto dto) {
        service.sendOtp(dto);
    ...
    public ResponseEntity<TokenResponseDto> verifyOtp(@RequestBody VerifyOtpDto dto) {
    ...
    public ResponseEntity<Map<String, String>> permissions(
        ...
        service.savePermissions(id, dto);
        return ResponseEntity.ok(
    ...
    public ResponseEntity<Map<String, String>> personalInfo(
        ...
        service.savePersonalInfo(id, dto);
        return ResponseEntity.ok(
    ...
    public ResponseEntity<Map<String, String>> dl(
        ...
        service.uploadDl(id, front, back);
        return ResponseEntity.ok(
